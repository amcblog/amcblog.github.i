...
#### 1.4.1) Định nghĩa 
1. Một số nguyên $$d$$ được gọi là *ước chung* của $$a$$ và $$b$$ nếu $$a$$ và $$b$$ cùng chia hết cho $$d$$, hay nói cách khác, khi $$d \mid a$$ và $$d \mid b$$.
...
Ta cần chứng minh rằng *ước chung* của $$a$$ và $$b$$ giống với *ước chung* của $$a + k.b$$ và $$b$$.
Giả sử rằng $$d \mid a$$ và $$d \mid b$$ thì $$a = x.d$$ và $$b = y.d$$ ($$x$$, $$y$$  là các số nguyên). Khi đó ta có:
...
Từ hai chứng minh trên ta suy ra tập *ước chung* của $$(a,b)$$ giống với tập *ước chung* của $$(a + k.b,b)$$. Do vậy $$gcd(a,b) = gcd(a + k.b,b)$$.
